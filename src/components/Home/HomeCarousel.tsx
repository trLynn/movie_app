...
const HomeCarousel = ({ carouselMovies }: HomecarouselProps) => {
    return (
        <div className="carousel-inner h-full">
            {
                carouselMovies.map((movie, id) => (
                    <Link to={`/details/${movie.id}`}>
                        <div key={id} className={`carousel-item ${id == 0 ? "active" : ""} h-full`}>
                            ...
                            <div className='absolute bottom-0 md:flex items-end gap-4 px-4'>
                                ...
                                <div className='flex flex-col gap-1'>
                                    ...
                                    <div className='flex items-center gap-1 text-zinc-400 lg:text-lg md:text-md'>
                                        <FiThumbsUp />
