            ...
            {details && params?.id ?
                <div className='relative h-fit w-full'>
                    <div className='relative'>
                        <img src={imagepath + details.backdrop_path} alt='background'
                            ...
                            <div className='md:flex gap-8'>
                                ...
                                <div className=''>
                                    <h1 className='lg:text-5xl md:text-4xl sm:text-3xl text-2xl'>{details?.original_title}
                                        <span className='md:mx-3 mx-1 lg:text-5xl md:text-4xl sm:text-3xl text-2xl'>({details?.release_date?.substring(0, 4)})</span>
                                    </h1>
                                    <div className='lg:text-xl md:text-lg sm:text-md text-slate-300 sm:mt-2 mt-1'>
                                        ...
                                        <div className='flex flex-col md:gap-3 gap-2 mt-4 text-zinc-300'>
                                            <h2 className=''>
                                                Genres: {details?.generes?.map(genre => genre.name).join(", ")}
                                            </h2>
